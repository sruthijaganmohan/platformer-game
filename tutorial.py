...
class Player(pygame.sprite.Sprite):
    ...
    def update_sprite(self):
        ...
        if self.hit:
            sprite_sheet = "hit"
        elif self.x_velocity != 0 and self.jump_count == 0:
            sprite_sheet = "run"
...
def handle_move(player, objects):
    ...
    vertical_collide = handle_vertical_collison(player, objects, player.y_velocity)
...
def main(window):
    ...
    objects = [*floor, Block(0, HEIGHT - block_size * 2, block_size), Block(block_size * 3, HEIGHT - block_size * 4, block_size), Block(block_size * 4, HEIGHT - block_size * 4, block_size), Block(block_size * 5, HEIGHT - block_size * 4, block_size), fire]
    offset_x = 0
